...
public class modifyFaculty extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            ps=con.prepareStatement("update faculty set id =?,name=?,password=?,phone_no=?,address=?,subject=? where id=?");
            int id = Integer.parseInt(idt.getText());
            String name_val = name.getText();
            String password = name_val+"@123";
            String subject_val = subject.getText();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new modifyFaculty().setVisible(true);
            }
        });
    }
